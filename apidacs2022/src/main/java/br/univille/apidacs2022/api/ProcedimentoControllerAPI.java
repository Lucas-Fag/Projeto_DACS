...
public class ProcedimentoControllerAPI {
    ...
    public ResponseEntity<List<Procedimento>> getAll() {
        List<Procedimento> listaProcedimentos = service.getAll();
    ...
    public ResponseEntity<List<Procedimento>> getByDescricao(@PathVariable("descricao") String descricao) {
        List<Procedimento> listaProcedimentos = service.getByDescricao(descricao);
    ...
    public ResponseEntity<Procedimento> update(@PathVariable("id") long id, @RequestBody Procedimento procedimento) {
        Procedimento procedimentoAntigo = service.findById(id);
